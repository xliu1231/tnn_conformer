...
## RHT 2D-Convolutional Layer
class RHT_Conv2d(nn.Module):

    def __init__(self, in_channels, out_channels, kernel_size, rank=None, cr=None,
                 stride=1, padding=0, dilation=1, groups=1, bias=True, padding_mode="zeros"):
        """
        Initialization of a RHT 2D-convolutional layer.
        ...
        """
        super(RHT_Conv2d, self).__init__()
...
#            / (self.in_channels // self.groups + self.out_channels + self.kernel_size[0] + self.kernel_size[1]))
    ...
    def forward(self, inputs):
        """
        Computation of the reshaped HT 2D-convolutional layer.

        Arguments:
        ----------
        inputs: a 4-th order tensor of size
        [batch_size, in_channels, in_height, in_width]
        Input to the reshaped HT 2D-convolutional layer.
...
## BT 2D-Convolutional Layer
class BT_Conv2d(nn.Module):
...
## RBT 2D-Convolutional Layer
class RBT_Conv2d(nn.Module):
